...
const ModalDeleteContact = (props) => {
    const { show, onClose, contactId, selection, branchId } = props;
    ...
    const handleDelete = async () => {
        ...
        if (contactId !== null && contactId !== undefined) {
            ...
            const listDetails = await new Promise((resolve, reject) => {
                axios.delete(`${process.env.REACT_APP_API_URL}contact/${contactId}`, { withCredentials: true })
                    .then(response => {
                        resolve(response);
            ...
            props.parentCallback({ state: true, status: listDetails.status, message: "contactDelete" });
        ...
        <Transition.Root show={show} as={Fragment}>
            ...
            <div className="inline-block w-[327px] align-bottom bg-[#033739] text-left overflow-hidden shadow-xl transform transition-all my-[2.5rem] m:my-[2rem] rounded-[1.875rem]">
                            ...
                            <div className="flex h-[120px] ml-[1rem] ">
                                ...
                                <div className='leading-[19.07px] tracking-[-5%] text-[20px] self-center text-[#FAFAFA] font-bold'>  ¿Seguro que deseas eliminar este contacto? </div>
